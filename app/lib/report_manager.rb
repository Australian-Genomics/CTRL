class ReportManager
  ...
  X_SMALL_WIDTH, SMALL_WIDTH, MEDIUM_WIDTH, LARGE_WIDTH, X_LARGE_WIDTH, XX_LARGE_WIDTH = 10, 15, 20, 25, 50, 100

  COLUMNS_WIDTH = [MEDIUM_WIDTH, X_LARGE_WIDTH, SMALL_WIDTH, XX_LARGE_WIDTH, LARGE_WIDTH, LARGE_WIDTH, MEDIUM_WIDTH]

  HEADERS = ['Study ID', 'Email Address', 'Step', 'Consent Question', 'Changes From', 'Changes To', 'When']
